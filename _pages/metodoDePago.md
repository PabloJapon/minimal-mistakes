...
<div class="wrap">
  ...
  <div id="overlay"></div>
    ...
    <form id="payment-form">
        <p><strong>Actualizar Método de Pago</strong></p>
        <div id="card-element" style="margin: 1em;"></div> <!-- Stripe card input -->
        <div id="card-errors" role="alert"></div> <!-- For displaying card errors -->
